...
public class Interfaz {
    public void componentes(JPanel panel){
        ...
        JLabel etiqueta = new JLabel("CONEXION A MYSQL Y POSTGRES");
        ...
        JButton conectarmysql = new JButton("Conectar a MYSQL");
        ...
        JButton conectarpostgres = new JButton("Conectar a POSTGRESQL");
    ...
    public static void main(String[] args) {
        ...
        //</editor-fold>
        JFrame ventana = new JFrame("Ventana conexion");
